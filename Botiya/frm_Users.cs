        ...
        private void BtnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    db.InsertEvent(frm_Main.userName, "اضافه کردن کاربر با نام کاربری " + txtUserName.Texts, frm_Login.strtoday + " " + DateTime.Now.ToString("HH:mm"));
        ...
        private void BtnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                if (MessageBoxFarsi.Show("آیا کاربر " + dgvUsers.CurrentRow.Cells[3].Value + "  حذف گردد؟", "حذف", MessageBoxFarsiButtons.YesNo, MessageBoxFarsiIcon.Delete, MessageBoxFarsiDefaultButton.Button1) == DialogResult.Yes)
                {
                    ...
                    db.InsertEvent(frm_Main.userName, " حذف کاربر با نام کاربری " + dgvUsers.CurrentRow.Cells[3].Value, frm_Login.strtoday + " " + DateTime.Now.ToString("HH:mm"));
                    CheckDgv();
                }
            }
            catch
        ...
        private void BtnOk_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    db.InsertEvent(frm_Main.userName, " بروز کردن کاربر با نام کاربری " + txtUserName.Texts, frm_Login.strtoday + " " + DateTime.Now.ToString("HH:mm"));
