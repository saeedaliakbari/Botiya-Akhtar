        ...
        private void BtnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    db.InsertEvent(frm_Main.userName, "اضافه کردن واحد " + txtVahedName.Texts, frm_Login.strtoday + " " + DateTime.Now.ToString("HH:mm"));
        ...
        private void BtnOk_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    db.InsertEvent(frm_Main.userName, "بروز کردن واحد " + txtVahedName.Texts, frm_Login.strtoday + " " + DateTime.Now.ToString("HH:mm"));
            ...
            try
            {
                if (MessageBoxFarsi.Show("آیا واحد "+ dgvVaheds.CurrentRow.Cells[1].Value + "  حذف گردد؟" , "حذف", MessageBoxFarsiButtons.YesNo, MessageBoxFarsiIcon.Delete, MessageBoxFarsiDefaultButton.Button1) == DialogResult.Yes)
                {
                    ...
                    if (resultVahed is null)
                    {
                        ...
                        db.InsertEvent(frm_Main.userName, "حذف کردن واحد " + dgvVaheds.CurrentRow.Cells[1].Value, frm_Login.strtoday + " " + DateTime.Now.ToString("HH:mm"));
                        bsVaheds.DataSource = db.FillVaheds();
                        CheckDgv();
                    }
                    else
