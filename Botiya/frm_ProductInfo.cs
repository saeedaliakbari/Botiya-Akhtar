            ...
            try
            {
                ...
                else
                {
                    ...
                    if (editMode)
                    {
                        ...
                        db.InsertEvent(frm_Main.userName, "بروز رسانی محصول با کد محصول " + txtCodeKala.Texts + " آیدی محصول" + idProduct, frm_Login.strtoday + " " + DateTime.Now.ToString("HH:mm"));
                    ...
                    else
                    {
                        ...
                        db.InsertEvent(frm_Main.userName, "اضافه کردن محصول با کد محصول " + txtCodeKala.Texts  , frm_Login.strtoday + " " + DateTime.Now.ToString("HH:mm"));
